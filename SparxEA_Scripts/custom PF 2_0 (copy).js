...
function DumpElements( indent, thePackage, diagramID, isDebugModeOn)
{
	...
	Session.Output("diagramID = " + diagramID);
	diagr = Repository.GetDiagramByGuid(diagramID);
	Session.Output("diagramID Name = " + diagr.Name);
...
RecursiveModelDumpExample(819, "Scripts",  "{A30D9122-CA39-4748-9511-48B3FBC32068}", false);
